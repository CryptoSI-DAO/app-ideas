...
## App Specification
- **App Name**: Slim Toaster
- **Bundle ID**: com.lisakim.slim-toaster
...
- **Keywords**: slim-toaster, reference, guide, offline, slimtoaster
- **Description**: Comprehensive slim toaster reference with offline access. Search, bookmark, and learn anytime.
- **Category**: Reference
- **Age Rating**: 4+
