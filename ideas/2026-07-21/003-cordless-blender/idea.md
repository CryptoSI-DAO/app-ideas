...
## App Specification
- **App Name**: Cordless Blender
- **Bundle ID**: com.lisakim.cordless-blender
...
## App Store Metadata
- **Title**: Cordless Blender
- **Subtitle**: Reference guide with offline access
- **Keywords**: cordless-blender, reference, guide, offline, cordlessblender
- **Description**: Comprehensive cordless blender reference with offline access. Search, bookmark, and learn anytime.
- **Category**: Reference
- **Age Rating**: 4+
